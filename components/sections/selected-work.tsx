...
// ─── Cover renderer (supports image / video / svg) ──────────────────────────
...
export default function SelectedWork() {
  ...
  // Show first 3 projects from real data
        ...
        <ScrollReveal variant="fade-up" className="mb-20 md:mb-32 border-b border-white/10 pb-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-16">
            ...
            <p className="text-[#8E8D8A] max-w-sm text-sm md:text-base leading-relaxed font-sans">
              A curated selection of brand identities, event productions, and motion work — crafted for Kuwait's most ambitious clients.
            </p>
          </div>
        </ScrollReveal>
              ...
              >
                ...
                <ParallaxCard tiltAmount={6} className="w-full h-full md:w-[60%] lg:w-[65%] md:h-auto relative z-20">
                  ...
                  <div className="relative w-full h-full md:aspect-[16/11] z-10 overflow-hidden md:rounded-lg bg-[#18181B] border border-white/10 shadow-2xl">
                    <ProjectCoverMedia
                      project={project}
                      className="transition-transform duration-[1500ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-[1.05]"
                    />
                ...
                {/* Text Content */}
                <div
                  className={`absolute bottom-0 left-0 w-full p-6 md:p-0 z-30 md:relative md:w-[40%] lg:w-[35%] flex flex-col justify-end md:justify-center ${
                    idx % 2 === 0 ? 'md:pr-6' : 'md:pl-6'
                  }`}
                >
                  <div className="flex items-center gap-4 mb-4 md:mb-6">
                    <span className="text-xs font-mono text-[#8E8D8A] font-numeric-tabular">{project.number}</span>
